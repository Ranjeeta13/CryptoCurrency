  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): DetailsFragmentArgs {
      ...
      if (bundle.containsKey("data")) {
        if (Parcelable::class.java.isAssignableFrom(CryptoCurrency::class.java) || Serializable::class.java.isAssignableFrom(CryptoCurrency::class.java)) {
          __data = bundle.get("data") as CryptoCurrency?
        } else {
          throw UnsupportedOperationException(CryptoCurrency::class.java.name + " must implement Parcelable or Serializable or must be an Enum.")
        }
      } else {
        __data = null
      }
